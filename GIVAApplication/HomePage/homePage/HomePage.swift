...
class HomePage: UIViewController,UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout {
    ...
    var name = ["PENDANTS","RINGS","EARRINGS","BRACELETS","MAN","COIN","NOSE PINS","CHAIN","TOE RINGS"]
    ...
    func navigation3()
    {
        let naviget = storyboard?.instantiateViewController(withIdentifier: "BracletePage") as! BracletePage
        navigationController?.pushViewController(naviget, animated: true)
    }
    func navigation4()
    {
        let naviget = storyboard?.instantiateViewController(withIdentifier: "ManRingPage") as! ManRingPage
        navigationController?.pushViewController(naviget, animated: true)
    }
    func navigation5()
    {
        let naviget = storyboard?.instantiateViewController(withIdentifier: "CoinPage") as! CoinPage
        navigationController?.pushViewController(naviget, animated: true)
    }
    func navigation6()
    {
        let naviget = storyboard?.instantiateViewController(withIdentifier: "NosePinPage") as! NosePinPage
        navigationController?.pushViewController(naviget, animated: true)
    }
    func navigation7()
    {
        let naviget = storyboard?.instantiateViewController(withIdentifier: "ChainPage") as! ChainPage
        navigationController?.pushViewController(naviget, animated: true)
    }
    func navigation8()
    {
        let naviget = storyboard?.instantiateViewController(withIdentifier: "ToeRingPage") as! ToeRingPage
        navigationController?.pushViewController(naviget, animated: true)
    }
